$(document).ready(function () {
    ...
    $("#update-vehicle").click(function () {
        ...
        $.post("meccanico/aggiornastato", {
            "ripId": ripId,
            "stato": status,
            "mecId": mecId
        }, function (riparazione, status) {
            if (status === "success") {
                if (riparazione.id !== -1) {
    ...
    $("#update-vehicle-lav").click(function () {
        ...
        $.post("meccanico/updateriparazione", riparazioneData, function (riparazione, status) {
            if (status === "success") {
    ...
    function getpezzi() {
        $(".pezzi-aggiunti").remove()
        const ripId = $("#vehiclePlate").attr("idrip");
        $.get("meccanico/getPezzi", {idRip: ripId}, function (collezione, status) {
            if (status === "success") {
